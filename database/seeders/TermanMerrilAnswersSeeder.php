...
*/
        //Arreglo con ids para PostgreeSQL
        $answers = [
            // ════════════════════════════════════════════════
            // SERIE I — Competence 56 (Información)
            // ════════════════════════════════════════════════
            ...
            // ════════════════════════════════════════════════
            [671, 59, 'A) ALTURA - LONGITUD',         0, 0],
            [671, 59, 'B) CIRCUNFERENCIA - RADIO',    1, 1],
            [671, 59, 'C) LATITUD - RADIO',           0, 0],
            [671, 59, 'D) LONGITUD - CIRCUNFERENCIA', 0, 0],
            [671, 59, 'E) RADIO - ALTURA',            0, 0],

            [672, 59, 'A) HUESOS - CANTO',   0, 0],
            [672, 59, 'B) HUEVOS - PLUMAS',  0, 0],
            [672, 59, 'C) PICO - HUESOS',    1, 1],
            [672, 59, 'D) NIDO - HUEVOS',    0, 0],
            [672, 59, 'E) CANTO - PLUMAS',   0, 0],

            [673, 59, 'A) OYENTE - PIANO',   0, 0],
            [673, 59, 'B) PIANO - VIOLÍN',   0, 0],
            [673, 59, 'C) RITMO - SONIDO',   1, 1],
            [673, 59, 'D) SONIDO - OYENTE',  0, 0],
            [673, 59, 'E) VIOLÍN - ACORDES', 0, 0],

            [674, 59, 'A) ALIMENTO - DISCURSO',  0, 0],
            [674, 59, 'B) MÚSICA - ANFITRIÓN',   0, 0],
            [674, 59, 'C) PERSONAS - ALIMENTO',  1, 1],
            [674, 59, 'D) DISCURSO - PERSONAS',  0, 0],
            [674, 59, 'E) ANFITRIÓN - ALIMENTO', 0, 0],

            [675, 59, 'A) ARNÉS - ESTABLO',      0, 0],
            [675, 59, 'B) CASCOS - COLA',        1, 1],
            [675, 59, 'C) HERRADURAS - CASCO',   0, 0],
            [675, 59, 'D) ESTABLO - HERRADURAS', 0, 0],
            [675, 59, 'E) COLA - ARNÉS',         0, 0],

            [676, 59, 'A) CARTAS - JUGADORES',   0, 0],
            [676, 59, 'B) MULTAS - REGLAS',      0, 0],
            [676, 59, 'C) JUGADORES - REGLAS',   1, 1],
            [676, 59, 'D) CASTIGOS - CARTAS',    0, 0],
            [676, 59, 'E) REGLAS - CASTIGOS',    0, 0],

            [677, 59, 'A) COLOR - PESO',   0, 0],
            [677, 59, 'B) TAMAÑO - SABOR', 0, 0],
            [677, 59, 'C) SABOR - COLOR',  0, 0],
            [677, 59, 'D) VALOR - TAMAÑO', 0, 0],
            [677, 59, 'E) PESO - TAMAÑO',  1, 1],

            [678, 59, 'A) ACUERDOS - PERSONAS',  0, 0],
            [678, 59, 'B) PERSONAS - PALABRAS',  1, 1],
            [678, 59, 'C) PREGUNTAS - INGENIO',  0, 0],
            [678, 59, 'D) INGENIO - ACUERDOS',   0, 0],
            [678, 59, 'E) PALABRAS - INGENIO',   0, 0],

            [679, 59, 'A) ACREEDOR - DEUDOR',    1, 1],
            [679, 59, 'B) DEUDOR - PAGO',        0, 0],
            [679, 59, 'C) INTERÉS - ACREEDOR',   0, 0],
            [679, 59, 'D) HIPOTECA - PAGO',      0, 0],
            [679, 59, 'E) PAGO - INTERÉS',       0, 0],

            [680, 59, 'A) PAÍS - DERECHOS',      1, 1],
            [680, 59, 'B) OCUPACIÓN - PAÍS',     0, 0],
            [680, 59, 'C) DERECHOS - VOTO',      0, 0],
            [680, 59, 'D) PROPIEDAD - DERECHOS', 0, 0],
            [680, 59, 'E) VOTO - PAÍS',          0, 0],

            [681, 59, 'A) ANIMALES - MINERALES',    0, 0],
            [681, 59, 'B) ORDEN - COLECCIONES',     1, 1],
            [681, 59, 'C) COLECCIONES - VISITANTES',0, 0],
            [681, 59, 'D) MINERALES - COLECCIONES', 0, 0],
            [681, 59, 'E) VISITANTES - ORDEN',      0, 0],

            [682, 59, 'A) OBLIGACIÓN - ACUERDO',  1, 1],
            [682, 59, 'B) ACUERDO - RESPETO',     0, 0],
            [682, 59, 'C) AMISTAD - OBLIGACIÓN',  0, 0],
            [682, 59, 'D) RESPETO - AMISTAD',     0, 0],
            [682, 59, 'E) SATISFACCIÓN - OBLIGACIÓN', 0, 0],

            [683, 59, 'A) ANIMALES - MALEZA',   0, 0],
            [683, 59, 'B) FLORES - SOMBRAS',    0, 0],
            [683, 59, 'C) SOMBRAS - ÁRBOLES',   1, 1],
            [683, 59, 'D) MALEZA - FLORES',     0, 0],
            [683, 59, 'E) ÁRBOLES - ANIMALES',  0, 0],

            [684, 59, 'A) DIFICULTAD - FRACASO',       0, 0],
            [684, 59, 'B) DESALIENTO - IMPEDIMENTO',   0, 0],
            [684, 59, 'C) FRACASO - ESTÍMULO',         0, 0],
            [684, 59, 'D) IMPEDIMENTO - DIFICULTAD',   1, 1],
            [684, 59, 'E) ESTÍMULO - DESALIENTO',      0, 0],

            [685, 59, 'A) AVERSIÓN - DESAGRADO',  1, 1],
            [685, 59, 'B) DESAGRADO - TEMOR',     0, 0],
            [685, 59, 'C) TEMOR - IRA',           0, 0],
            [685, 59, 'D) IRA - AVERSIÓN',        0, 0],
            [685, 59, 'E) TIMIDEZ - DESAGRADO',   0, 0],

            [686, 59, 'A) ANUNCIOS - PAPEL',       0, 0],
            [686, 59, 'B) PAPEL - IMPRESIÓN',      1, 1],
            [686, 59, 'C) FOTOGRAFÍAS - ANUNCIOS', 0, 0],
            [686, 59, 'D) GRABADOS - IMPRESIÓN',   0, 0],
            [686, 59, 'E) IMPRESIÓN - FOTOGRAFÍAS',0, 0],

            [687, 59, 'A) ARGUMENTO - PÚBLICO',      0, 0],
            [687, 59, 'B) DESACUERDOS - ARGUMENTO',  1, 1],
            [687, 59, 'C) AVERSIÓN - RESUMEN',       0, 0],
            [687, 59, 'D) PÚBLICO - DESACUERDO',     0, 0],
            [687, 59, 'E) RESUMEN - ARGUMENTO',      0, 0],

            [688, 59, 'A) MAQUINARIA - CAÑONES', 0, 0],
            [688, 59, 'B) CAÑONES - VELAS',      0, 0],
            [688, 59, 'C) QUILLA - MAQUINARIA',  0, 0],
            [688, 59, 'D) TIMÓN - QUILLA',       1, 1],
            [688, 59, 'E) VELAS - TIMÓN',        0, 0],

            // ════════════════════════════════════════════════
            // SERIE V — Competence 60 (Aritmética)
            // ════════════════════════════════════════════════
            [689, 60, 'A) 30', 0, 0], [689, 60, 'B) 15', 0, 0], [689, 60, 'C) 20', 1, 1], [689, 60, 'D) 25', 0, 0], [689, 60, 'E) 18', 0, 0],
            [690, 60, 'A) 7',  0, 0], [690, 60, 'B) 10', 0, 0], [690, 60, 'C) 15', 0, 0], [690, 60, 'D) 11', 1, 1], [690, 60, 'E) 13', 0, 0],
            [691, 60, 'A) 38', 0, 0], [691, 60, 'B) 45', 0, 0], [691, 60, 'C) 60', 0, 0], [691, 60, 'D) 55', 0, 0], [691, 60, 'E) 50', 1, 1],
            [692, 60, 'A) 25', 0, 0], [692, 60, 'B) 50', 1, 1], [692, 60, 'C) 75', 0, 0], [692, 60, 'D) 100',0, 0], [692, 60, 'E) 150',0, 0],
            [693, 60, 'A) 12', 1, 1], [693, 60, 'B) 8',  0, 0], [693, 60, 'C) 10', 0, 0], [693, 60, 'D) 19', 0, 0], [693, 60, 'E) 16', 0, 0],
            [694, 60, 'A) 12', 0, 0], [694, 60, 'B) 16', 0, 0], [694, 60, 'C) 18', 1, 1], [694, 60, 'D) 20', 0, 0], [694, 60, 'E) 24', 0, 0],
            [695, 60, 'A) 300',0, 0], [695, 60, 'B) 500',1, 1], [695, 60, 'C) 180',0, 0], [695, 60, 'D) 700',0, 0], [695, 60, 'E) 243',0, 0],
            [696, 60, 'A) 1',  0, 0], [696, 60, 'B) 6',  0, 0], [696, 60, 'C) 2',  1, 1], [696, 60, 'D) 4',  0, 0], [696, 60, 'E) 8',  0, 0],
            [697, 60, 'A) 14', 0, 0], [697, 60, 'B) 21', 0, 0], [697, 60, 'C) 24', 0, 0], [697, 60, 'D) 28', 1, 1], [697, 60, 'E) 32', 0, 0],
            [698, 60, 'A) 360',1, 1], [698, 60, 'B) 320',0, 0], [698, 60, 'C) 340',0, 0], [698, 60, 'D) 325',0, 0], [698, 60, 'E) 380',0, 0],
            [699, 60, 'A) 1',  0, 0], [699, 60, 'B) 2',  1, 1], [699, 60, 'C) 3',  0, 0], [699, 60, 'D) 4',  0, 0], [699, 60, 'E) 5',  0, 0],
            [700, 60, 'A) 18%',0, 0], [700, 60, 'B) 15%',0, 0], [700, 60, 'C) 20%',0, 0], [700, 60, 'D) 28%',0, 0], [700, 60, 'E) 25%',1, 1],

            // ════════════════════════════════════════════════
            // SERIE VI — Competence 61 (Comprensión Verbal)
            // ════════════════════════════════════════════════
            [701, 61, 'Sí', 1, 1], [701, 61, 'No', 0, 0],
            [702, 61, 'Sí', 0, 0], [702, 61, 'No', 1, 1],
            [703, 61, 'Sí', 0, 0], [703, 61, 'No', 1, 1],
            [704, 61, 'Sí', 1, 1], [704, 61, 'No', 0, 0],
            [705, 61, 'Sí', 1, 1], [705, 61, 'No', 0, 0],
            [706, 61, 'Sí', 0, 0], [706, 61, 'No', 1, 1],
            [707, 61, 'Sí', 0, 0], [707, 61, 'No', 1, 1],
            [708, 61, 'Sí', 0, 0], [708, 61, 'No', 1, 1],
            [709, 61, 'Sí', 1, 1], [709, 61, 'No', 0, 0],
            [710, 61, 'Sí', 1, 1], [710, 61, 'No', 0, 0],
            [711, 61, 'Sí', 0, 0], [711, 61, 'No', 1, 1],
            [712, 61, 'Sí', 0, 0], [712, 61, 'No', 1, 1],
            [713, 61, 'Sí', 0, 0], [713, 61, 'No', 1, 1],
            [714, 61, 'Sí', 1, 1], [714, 61, 'No', 0, 0],
            [715, 61, 'Sí', 0, 0], [715, 61, 'No', 1, 1],
            ...
            // ════════════════════════════════════════════════
            [721, 62, 'A) COMER',    1, 1], [721, 62, 'B) HAMBRE',   0, 0], [721, 62, 'C) AGUA',     0, 0], [721, 62, 'D) COCINA',   0, 0],
            [722, 62, 'A) AÑO',     1, 1], [722, 62, 'B) HORA',     0, 0], [722, 62, 'C) MINUTO',   0, 0], [722, 62, 'D) SEGUNDO',  0, 0],
            [723, 62, 'A) OLOR',    0, 0], [723, 62, 'B) HOJA',     0, 0], [723, 62, 'C) PLANTA',   1, 1], [723, 62, 'D) ESPINA',   0, 0],
            [724, 62, 'A) NEGRO',   0, 0], [724, 62, 'B) ESCLAVITUD',1, 1], [724, 62, 'C) LIBRE',    0, 0], [724, 62, 'D) SUFRIR',   0, 0],
            [725, 62, 'A) CANTAR',  0, 0], [725, 62, 'B) ESTUVO',   1, 1], [725, 62, 'C) HABLANDO', 0, 0], [725, 62, 'D) CANTÓ',    0, 0],
            [726, 62, 'A) SEMANA',  0, 0], [726, 62, 'B) JUEVES',   0, 0], [726, 62, 'C) DÍA',      0, 0], [726, 62, 'D) SÁBADO',   1, 1],
            [727, 62, 'A) BOTELLA', 0, 0], [727, 62, 'B) PESO',     0, 0], [727, 62, 'C) LIGERO',   1, 1], [727, 62, 'D) FLOTAR',   0, 0],
            [728, 62, 'A) TRISTEZA',1, 1], [728, 62, 'B) SUERTE',   0, 0], [728, 62, 'C) FRACASAR', 0, 0], [728, 62, 'D) TRABAJO',  0, 0],
            [729, 62, 'A) LOBO',    1, 1], [729, 62, 'B) LADRIDO',  0, 0], [729, 62, 'C) MORDIDA',  0, 0], [729, 62, 'D) AGARRAR',  0, 0],
            [730, 62, 'A) SIETE',    0, 0], [730, 62, 'B) CUARENTA Y CINCO', 0, 0], [730, 62, 'C) TREINTA Y CINCO', 0, 0], [730, 62, 'D) VEINTICINCO', 1, 1],
            [731, 62, 'A) MUERTE',  0, 0], [731, 62, 'B) ALEGRE',   1, 1], [731, 62, 'C) MORTAJA',  0, 0], [731, 62, 'D) DOCTOR',   0, 0],
            [732, 62, 'A) COMER',   0, 0], [732, 62, 'B) PÁJARO',   0, 0], [732, 62, 'C) VIDA',     1, 1], [732, 62, 'D) MALO',     0, 0],
            [733, 62, 'A) 18',      0, 0], [733, 62, 'B) 27',       1, 1], [733, 62, 'C) 36',       0, 0], [733, 62, 'D) 45',       0, 0],
            [734, 62, 'A) BEBER',   0, 0], [734, 62, 'B) CLARO',    0, 0], [734, 62, 'C) SED',      1, 1], [734, 62, 'D) PURO',     0, 0],
            [735, 62, 'A) ESTOS',   0, 0], [735, 62, 'B) AQUEL',    0, 0], [735, 62, 'C) ESE',      1, 1], [735, 62, 'D) ENTONCES', 0, 0],
            [736, 62, 'A) AGUA',    0, 0], [736, 62, 'B) PEZ',      0, 0], [736, 62, 'C) ESCAMA',   1, 1], [736, 62, 'D) NADAR',    0, 0],
            [737, 62, 'A) PATRIA',  0, 0], [737, 62, 'B) HONRADO',  1, 1], [737, 62, 'C) SANCIÓN',  0, 0], [737, 62, 'D) ESTUDIO',  0, 0],
            [738, 62, 'A) TERCERO', 0, 0], [738, 62, 'B) ÚLTIMO',   0, 0], [738, 62, 'C) CUARTO',   1, 1], [738, 62, 'D) POSTERIOR',0, 0],
            [739, 62, 'A) MARINA',  0, 0], [739, 62, 'B) SOLDADO',  0, 0], [739, 62, 'C) GENERAL',  1, 1], [739, 62, 'D) SARGENTO', 0, 0],
            [740, 62, 'A) PRONOMBRE',0, 0],[740, 62, 'B) ADVERBIO',  0, 0], [740, 62, 'C) VERBO',    1, 1], [740, 62, 'D) ADJETIVO', 0, 0],

            // ════════════════════════════════════════════════
            // SERIE VIII — Competence 63 (Ordenamiento)
            // ════════════════════════════════════════════════
            [741, 63, 'VERDADERO', 1, 1], [741, 63, 'FALSO', 0, 0],
            [742, 63, 'VERDADERO', 0, 0], [742, 63, 'FALSO', 1, 1],
            [743, 63, 'VERDADERO', 1, 1], [743, 63, 'FALSO', 0, 0],
            [744, 63, 'VERDADERO', 1, 1], [744, 63, 'FALSO', 0, 0],
            [745, 63, 'VERDADERO', 1, 1], [745, 63, 'FALSO', 0, 0],
            [746, 63, 'VERDADERO', 0, 0], [746, 63, 'FALSO', 1, 1],
            [747, 63, 'VERDADERO', 0, 0], [747, 63, 'FALSO', 1, 1],
            [748, 63, 'VERDADERO', 1, 1], [748, 63, 'FALSO', 0, 0],
            [749, 63, 'VERDADERO', 1, 1], [749, 63, 'FALSO', 0, 0],
            [750, 63, 'VERDADERO', 0, 0], [750, 63, 'FALSO', 1, 1],
            [751, 63, 'VERDADERO', 0, 0], [751, 63, 'FALSO', 1, 1],
            [752, 63, 'VERDADERO', 0, 0], [752, 63, 'FALSO', 1, 1],
            [753, 63, 'VERDADERO', 1, 1], [753, 63, 'FALSO', 0, 0],
            ...
            // ════════════════════════════════════════════════
            [758, 64, 'A) SALTAR',    0, 0], [758, 64, 'B) CORRER',     0, 0], [758, 64, 'C) BRINCAR',    0, 0], [758, 64, 'D) PARARSE',    1, 1], [758, 64, 'E) CAMINAR',    0, 0],
            [759, 64, 'A) MONARQUÍA', 0, 0], [759, 64, 'B) COMUNISTA',  0, 0], [759, 64, 'C) DEMÓCRATA',  0, 0], [759, 64, 'D) ANARQUISTA', 0, 0], [759, 64, 'E) CATÓLICO',   1, 1],
            [760, 64, 'A) MUERTE',    0, 0], [760, 64, 'B) DUELO',      0, 0], [760, 64, 'C) PASEO',      1, 1], [760, 64, 'D) POBREZA',    0, 0], [760, 64, 'E) TRISTEZA',   0, 0],
            [761, 64, 'A) CARPINTERO',1, 1], [761, 64, 'B) DOCTOR',     0, 0], [761, 64, 'C) ABOGADO',    0, 0], [761, 64, 'D) INGENIERO',  0, 0], [761, 64, 'E) PROFESOR',   0, 0],
            [762, 64, 'A) CAMA',      0, 0], [762, 64, 'B) SILLA',      0, 0], [762, 64, 'C) PLATO',      1, 1], [762, 64, 'D) SOPA',       0, 0], [762, 64, 'E) MESA',       0, 0],
            [763, 64, 'A) FRANCISCO', 0, 0], [763, 64, 'B) SANTIAGO',   0, 0], [763, 64, 'C) JUAN',       0, 0], [763, 64, 'D) SARA',       1, 1], [763, 64, 'E) GUILLÉN',    0, 0],
            [764, 64, 'A) DURO',      0, 0], [764, 64, 'B) ÁSPERO',     0, 0], [764, 64, 'C) LISO',       0, 0], [764, 64, 'D) SUAVE',      0, 0], [764, 64, 'E) DULCE',      1, 1],
            [765, 64, 'A) DIGESTIVO', 1, 1], [765, 64, 'B) ODIO',       0, 0], [765, 64, 'C) VISTA',      0, 0], [765, 64, 'D) OLFATO',     0, 0], [765, 64, 'E) TACTO',      0, 0],
            [766, 64, 'A) AUTOMÓVIL', 0, 0], [766, 64, 'B) BICICLETA',  0, 0], [766, 64, 'C) GUAYÍN',     0, 0], [766, 64, 'D) TELÉGRAFO',  1, 1], [766, 64, 'E) TREN',       0, 0],
            [767, 64, 'A) ABAJO',     0, 0], [767, 64, 'B) ACÁ',        0, 0], [767, 64, 'C) RECIENTE',   1, 1], [767, 64, 'D) ARRIBA',     0, 0], [767, 64, 'E) ALLÁ',       0, 0],
            [768, 64, 'A) HIDALGO',   0, 0], [768, 64, 'B) MORELOS',    0, 0], [768, 64, 'C) BRAVO',      0, 0], [768, 64, 'D) MATAMOROS',  0, 0], [768, 64, 'E) BOLÍVAR',    1, 1],
            [769, 64, 'A) DANÉS',     0, 0], [769, 64, 'B) GALGO',      0, 0], [769, 64, 'C) BULLDOG',    0, 0], [769, 64, 'D) PEKINÉS',    0, 0], [769, 64, 'E) LONGHORI',   1, 1],
            [770, 64, 'A) TELA',      1, 1], [770, 64, 'B) ALGODÓN',    0, 0], [770, 64, 'C) LINO',       0, 0], [770, 64, 'D) SEDA',       0, 0], [770, 64, 'E) LANA',       0, 0],
            [771, 64, 'A) IRA',       0, 0], [771, 64, 'B) ODIO',       0, 0], [771, 64, 'C) ALEGRÍA',    0, 0], [771, 64, 'D) PIEDAD',     0, 0], [771, 64, 'E) RAZONAMIENTO',1, 1],
            [772, 64, 'A) EDISON',    0, 0], [772, 64, 'B) FRANKLIN',   0, 0], [772, 64, 'C) MARCONI',    0, 0], [772, 64, 'D) FULTON',     0, 0], [772, 64, 'E) SHAKESPEARE', 1, 1],
            [773, 64, 'A) MARIPOSA',  1, 1], [773, 64, 'B) HALCÓN',     0, 0], [773, 64, 'C) AVESTRUZ',   0, 0], [773, 64, 'D) PETIRROJO',  0, 0], [773, 64, 'E) GOLONDRINA', 0, 0],
            [774, 64, 'A) DAR',       0, 0], [774, 64, 'B) PRESTAR',    0, 0], [774, 64, 'C) PERDER',     0, 0], [774, 64, 'D) AHORRAR',    1, 1], [774, 64, 'E) DERROCHAR',  0, 0],
            [775, 64, 'A) AUSTRALIA', 0, 0], [775, 64, 'B) CUBA',       0, 0], [775, 64, 'C) CÓRCEGA',    0, 0], [775, 64, 'D) IRLANDA',    0, 0], [775, 64, 'E) ESPAÑA',     1, 1],

            // ════════════════════════════════════════════════
            // SERIE X — Competence 65 (Series Numéricas)
            // ════════════════════════════════════════════════
            [776, 65, 'A) 3 – 2',   0, 0], [776, 65, 'B) 2 – 1',   1, 1], [776, 65, 'C) 1 – 0',   0, 0], [776, 65, 'D) 2 – 0',   0, 0], [776, 65, 'E) 4 – 3',   0, 0],
            [777, 65, 'A) 34 – 38', 0, 0], [777, 65, 'B) 31 – 36', 0, 0], [777, 65, 'C) 32 – 37', 0, 0], [777, 65, 'D) 33 – 38', 1, 1], [777, 65, 'E) 36 – 39', 0, 0],
            [778, 65, 'A) 48 – 96', 0, 0], [778, 65, 'B) 56 – 112',0, 0], [778, 65, 'C) 64 – 128',1, 1], [778, 65, 'D) 72 – 144',0, 0], [778, 65, 'E) 80 – 160',0, 0],
            [779, 65, 'A) 3 – 3',   0, 0], [779, 65, 'B) 2 – 4',   0, 0], [779, 65, 'C) 4 – 2',   0, 0], [779, 65, 'D) 1 – 1',   0, 0], [779, 65, 'E) 2 – 2',   1, 1],
            [780, 65, 'A) 13 – 13',     0, 0], [780, 65, 'B) 12¾ – 13',  0, 0], [780, 65, 'C) 13 – 13¼',  1, 1], [780, 65, 'D) 13¼ – 13½', 0, 0], [780, 65, 'E) 12½ – 13',  0, 0],
            [781, 65, 'A) 20 – 21', 1, 1], [781, 65, 'B) 19 – 20', 0, 0], [781, 65, 'C) 23 – 24', 0, 0], [781, 65, 'D) 21 – 22', 0, 0], [781, 65, 'E) 18 – 19', 0, 0],
            [782, 65, 'A) ½ – ¼',   0, 0], [782, 65, 'B) ¼ – 1/16',0, 0], [782, 65, 'C) ¼ – ⅛',   1, 1], [782, 65, 'D) ⅛ – 1/16',0, 0], [782, 65, 'E) 1/16 – 1/32', 0, 0],
            [783, 65, 'A) 83.3 – 92.3', 0, 0], [783, 65, 'B) 84.3 – 93.3', 0, 0], [783, 65, 'C) 82.3 – 94.3', 0, 0], [783, 65, 'D) 86.3 – 95.3', 0, 0], [783, 65, 'E) 85.3 – 94.3', 1, 1],
            [784, 65, 'A) 6 – 8',   1, 1], [784, 65, 'B) 5 – 6',   0, 0], [784, 65, 'C) 6 – 9',   0, 0], [784, 65, 'D) 7 – 8',   0, 0], [784, 65, 'E) 5 – 7',   0, 0],
            [785, 65, 'A) 30 – 31', 0, 0], [785, 65, 'B) 31 – 32', 0, 0], [785, 65, 'C) 32 – 33', 0, 0], [785, 65, 'D) 33 – 34', 1, 1], [785, 65, 'E) 34 – 35', 0, 0],
            [786, 65, 'A) 10 – 25',  0, 0], [786, 65, 'B) 25 – 125', 1, 1], [786, 65, 'C) 20 – 100',0, 0], [786, 65, 'D) 20 – 125', 0, 0], [786, 65, 'E) 15 – 120', 0, 0],
        ];
