...
{{--                        <!-- Form Group -->--}}
{{--                        <div>--}}
{{--                            <label for="title" class="block text-sm mb-2 dark:text-white">Título de la Notificación</label>--}}
{{--                            <div class="relative">--}}
{{--                                <input wire:model="titleMessage" type="text" id="title" name="titulo" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="email-error">--}}
...
{{--                        <!-- Form Group -->--}}
{{--                        <div>--}}
{{--                            <label for="body" class="block text-sm mb-2 dark:text-white">Mensaje</label>--}}
{{--                            <div class="relative">--}}
{{--                                <textarea wire:model="body"  type="text" id="body" name="body"--}}
...
{{--                        <!-- Form Group -->--}}
{{--                        <div>--}}
{{--                            <label for="confirm-password" class="block text-sm mb-2 dark:text-white">Selecciones los destinatarios</label>--}}

{{--                            <div class="relative">--}}
{{--                                <select wire:model="recip" multiple id="sedes" name="recip">--}}
