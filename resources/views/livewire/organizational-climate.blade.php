            ...
            <main class="container mb-0">
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    ...
                    <div class="text-body-secondary pt-3">
                        <h6>¡Bienvenido a de {{$tipodeEvaluacion}}! </h6>
                ...
                <div class="d-flex justify-content-end gap-2 mb-5">
                    <button class="btn btn-outline-secondary btn-lg px-4 rounded-pill" type="button" onClick="window.location.href='dashboard/organizational-climate'">
                        Cancelar
                    </button>
    ...
    <main class="container">
                ...
                @foreach($preguntas as $pregunta)
                    <div wire:loading.delay.shortest
                         ...
                         class="d-flex align-items-center p-3 my-3 bg-body rounded shadow-sm mt-3">
                        <i class="fas fa-chevron-right fa-lg mx-2" style="@error("respuestas.{$pregunta->id}") color:#ff0a0a;  @enderror"></i>
                        <div class="lh-1">
                            ...
                            <div class="likert" >
                                @foreach(range(1, 5) as $valor)
                                    <label>
                                        ...
                                        <div class="likert-text mt-2">{{ $valor == 1 ? 'Totalmente en Desacuerdo' : ($valor == 2 ? 'En Desacuerdo' : ($valor == 3 ? 'Neutral' : ($valor == 4 ? 'De Acuerdo' : 'Totalmente de Acuerdo'))) }}</div>
                                        </span>
                                    </label>
