			...
			<div role="main" class="main">
					...
					<div class="container pb-5 my-3">
						<div class="row mb-4">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-color-dark text-10">Evaluación 360</h1>
							</div>
				...
				<div class="container pt-3 mt-4">
					<div class="row mb-5">
						<div class="col-lg-7">
							<p class="text-3-5">
                                El Módulo de Evaluación 360 te permite obtener una visión integral y objetiva del desempeño de tus empleados. Pero, ¿qué es exactamente la evaluación 360?
                            </p>
                            <p class="text-3-5">
                                La evaluación 360 es un método valioso, que recopila retroalimentación sobre el desempeño de un empleado desde múltiples perspectivas:
                            </p>
                            <ul>
                                <li>Autoevaluación: El propio empleado reflexiona sobre su desempeño.</li>
                                <li>Superiores: Sus jefes directos evalúan su rendimiento.</li>
                                <li>Compañeros: Colegas que trabajan estrechamente con el empleado aportan su visión.</li>
                                <li>Subordinados: Si aplica, aquellos que reportan al empleado también participan.</li>
                                <li>Clientes (internos o externos): En algunos casos, se incluye la opinión de quienes interactúan con el empleado.</li>
                            </ul>
                            <p class="text-3-5">
                                Nuestro Módulo de Evaluación 360 facilita este proceso, permitiendo:

                            </p>
                            <ul>
                                <li>Personalizar las evaluaciones según los roles y necesidades de tu organización.</li>
                                <li>Recopilar y analizar la retroalimentación de manera eficiente.</li>
                                <li>Identificar fortalezas y áreas de mejora de cada empleado.</li>
                                <li>Promover un ambiente de desarrollo continuo y reconocimiento justo.</li>
                                <li>Gestionar todo el proceso de evaluación de forma eficiente.</li>
                                <li>Con nuestro Módulo de Evaluación 360, podrás tomar decisiones más informadas sobre el desarrollo y la gestión del talento en tu empresa. </li>
                            </ul>
                        </div>
