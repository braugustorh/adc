            ...
            <div class="container pb-5 my-3">
                <div class="row mb-4">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <h1 class="font-weight-bold text-color-dark text-10">9 Box</h1>
                    </div>
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block text-center">
                            <li><a href="{{route('welcome')}}">Inicio</a></li>
                            <li class="active">9Box</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-7">
                    <div class="container mt-5">
                        ...
                        <p class="text-3-5">Nuestro módulo de 9 Box (Matriz de 9 Cuadrantes) te ofrece una herramienta visual y estratégica para la gestión del talento. Pero, ¿qué es exactamente el 9 Box?</p>
                        <p class="text-3-5">
                            La matriz de 9 Box es un modelo que evalúa a los colaboradores en función de dos ejes clave:
                        </p>
                        <div class="row">
                            <div class="col-md-12">
                                <h4>Potencial:</h4>
                                <p class="text-3-5">
                                    La capacidad de un empleado para crecer y asumir roles de mayor responsabilidad en el futuro.
                                </p>

                                <h4>Desempeño:</h4>
                                <p class="text-3-5">El rendimiento actual del empleado en su puesto de trabajo.</p>
                            </div>

                            <div class="col-md-12">
                                <h4>Esta matriz divide a los colaboradores en nueve categorías, permitiendo:</h4>
                                <ul class="text-3-5">
                                    <li>Identificar a los empleados de alto potencial y alto desempeño (estrellas).</li>
                                    <li>Reconocer a los empleados con potencial de crecimiento.</li>
                                    <li>Detectar a los empleados que requieren desarrollo o apoyo.</li>
                                    <li>Facilitar la toma de decisiones sobre planes de sucesión y desarrollo profesional.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <p class="text-3-5">Con nuestro módulo de 9 Box, podrás optimizar la gestión del talento, identificar a los futuros líderes y fortalecer el desarrollo profesional en tu empresa.</p>
                    </div>
