            ...
            <div class="container pb-5 my-3">
                <div class="row mb-4">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <h1 class="font-weight-bold text-color-dark text-10">Clima Organizacional</h1>
                    </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-7">
                    <div class="container mt-5">
                        <h4>Clima Organizacional: Midiendo la Percepción del Ambiente Laboral</h4>
                        <p class="text-3-5">Nuestro módulo de Clima Organizacional te permite obtener una visión clara y precisa del ambiente de trabajo en tu organización. Pero, ¿qué es exactamente el clima organizacional?</p>
                        <p class="text-3-5">El clima organizacional se refiere a la percepción que tienen los colaboradores sobre el entorno laboral, incluyendo:</p>
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Cultura:</h4>
                                <p class="text-3-5">Los valores, creencias y normas que rigen la organización.</p>

                                <h4>Comunicación:</h4>
                                <p class="text-3-5">La fluidez y efectividad de la comunicación interna.</p>

                                <h4>Liderazgo:</h4>
                                <p class="text-3-5">El estilo y la efectividad de los líderes.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Reconocimiento:</h4>
                                <p class="text-3-5">El reconocimiento y la valoración del trabajo de los empleados.</p>

                                <h4>Desarrollo:</h4>
                                <p class="text-3-5">Las oportunidades de crecimiento y desarrollo profesional.</p>
                            </div>
                        </div>

                        <h4>Nuestro módulo de Clima Organizacional te permite:</h4>
                        <ul class="text-3-5">
                            <li>Recopilar datos de manera anónima y confidencial.</li>
                            <li>Personalizar encuestas para adaptarlas a tus necesidades.</li>
                            <li>Generar informes detallados y visualizaciones de datos.</li>
                            <li>Identificar áreas de mejora y fortalezas en el ambiente laboral.</li>
                            <li>Realizar un seguimiento del clima organizacional a lo largo del tiempo.</li>
                            <li>Permitir tomar decisiones estratégicas para mejorar el ambiente laboral.</li>
                        </ul>

                        <p class="text-3-5">Con nuestro módulo de Clima Organizacional, podrás tomar decisiones informadas para mejorar el ambiente de trabajo, aumentar la satisfacción de los empleados y fortalecer la cultura organizacional.</p>
                    </div>
                </div>
                <div class="col-10 col-lg-4 ms-auto pt-4 pt-5 pt-lg-4 pb-5">
                    <div class="cascading-images-wrapper p-0 mt-5 mb-5">
                        <div class="cascading-images position-relative">
                            <img src="img/demos/business-consulting-3/generic/eva-360.jpg" class="box-shadow-4 appear-animation" alt="" data-appear-animation="expandIn" data-appear-animation-duration="600ms" />
                            <div class="position-absolute w-100" style="top: 61%; left: -20%;">
                                <img src="img/demos/business-consulting-3/generic/eva360-front.webp" class="box-shadow-4 appear-animation" width="285" alt="" data-appear-animation="expandIn" data-appear-animation-delay="300" data-appear-animation-duration="600ms" />
                            </div>
                        </div>
                    </div>
                </div>
