            ...
            <div class="container pb-5 my-3">
                <div class="row mb-4">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <h1 class="font-weight-bold text-color-dark text-10">Face to Face</h1>
                    </div>
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block text-center">
                            <li><a href="{{route('welcome')}}">Inicio</a></li>
                            <li class="active">F2F</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-7">
                    <div class="container mt-5">
                        <p class="text-3-5">El Módulo Face to Face está diseñado para potenciar las
                            conversaciones de desarrollo entre jefes y colaboradores.
                            Este módulo facilita las entrevistas cara a cara, un espacio crucial para:</p>

                        <div class="row">
                            <div class="col-md-6">
                                <h4>Reforzar aspectos positivos:</h4>
                                <ul>
                                    <li>Reconocer los logros y fortalezas del colaborador.</li>
                                    <li>Fomentar un ambiente de reconocimiento y motivación.</li>
                                </ul>

                                <h4>Revisar áreas de mejora:</h4>
                                <ul>
                                    <li>Abordar constructivamente los desafíos y áreas de oportunidad.</li>
                                    <li>Proporcionar retroalimentación clara y específica.</li>
                                </ul>
                            </div>

                            <div class="col-md-6">
                                <h4>Establecer planes de acción:</h4>
                                <ul>
                                    <li>Definir objetivos claros y alcanzables.</li>
                                    <li>Crear un plan de desarrollo personalizado.</li>
                                    <li>Hacer seguimiento de los objetivos.</li>
                                </ul>

                                <h4>Mejorar la comunicación:</h4>
                                <ul>
                                    <li>Generar un espacio de confianza.</li>
                                    <li>Construir una mejor relación entre jefe y colaborador.</li>
                                </ul>
                            </div>
                        </div>
