            ...
            <div class="row mb-5">
                <div class="col-lg-7">
                    <div class="container mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Condiciones del ambiente de trabajo:</h4>
                                <p class="text-3-5">Factores como la carga de trabajo, la falta de control y la violencia laboral.</p>

                                <h4>Exigencias del trabajo:</h4>
                                <p class="text-3-5">Demandas que superan las capacidades de los empleados.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Relaciones laborales:</h4>
                                <p class="text-3-5">Interacciones entre compañeros y superiores.</p>

                                <h4>Organización del trabajo:</h4>
                                <p class="text-3-5">Aspectos como la claridad de roles y la participación en la toma de decisiones.</p>
                            </div>
                        </div>
