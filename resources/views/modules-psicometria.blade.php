            ...
            <div class="container pb-5 my-3">
                <div class="row mb-4">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        ...
                        <h3 class="text-color-primary">‍🚧Módulo en Desarrollo🚧 </h3>
                    </div>
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb d-block text-center">
                            <li><a href="{{route('welcome')}}">Inicio</a></li>
                            <li class="active">Piscometría</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-7">
                    <div class="container mt-5">
                        <h4>Psicométricas: Descubre el Potencial y las Características de tus Colaboradores</h4>
                        <p class="text-3-5">
                            Nuestro módulo de Psicométricas te permite obtener información valiosa sobre
                            las características y el potencial de tus colaboradores.
                        </p>
                        <p class="text-3-5">
                            Las pruebas psicométricas son herramientas que miden diversos aspectos de la personalidad,
                            inteligencia, comportamiento y reacciones de un individuo, a través de:
                        </p>

                        <div class="row">
                            <div class="col-md-6">
                                <h4>Preguntas estructuradas:</h4>
                                <p class="text-3-5">Cuestionarios diseñados para evaluar rasgos específicos.</p>

                                <h4>Situaciones simuladas:</h4>
                                <p class="text-3-5">Escenarios que permiten observar el comportamiento en contextos particulares.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Evaluación de habilidades cognitivas:</h4>
                                <p class="text-3-5">Pruebas que miden la capacidad de razonamiento, memoria y otras funciones mentales.</p>
                            </div>
                        </div>

                        <h4>Nuestro módulo de Psicométricas te permite:</h4>
                        <ul class="text-3-5">
                            <li>Seleccionar y aplicar pruebas psicométricas personalizadas.</li>
                            <li>Generar informes detallados con resultados y análisis.</li>
                            <li>Identificar fortalezas y áreas de desarrollo en los colaboradores.</li>
                            <li>Apoyar la toma de decisiones en procesos de selección y desarrollo.</li>
                            <li>Mejorar la comprensión del comportamiento y potencial de los empleados.</li>
                            <li>Permite identificar el talento de los empleados.</li>
                        </ul>

                        <p class="text-3-5">Con nuestro módulo de Psicométricas, podrás optimizar la gestión del talento, tomar decisiones más informadas y potenciar el desarrollo de tus colaboradores.</p>
                    </div>
                </div>
