            ...
            <div class="row mb-5">
                <div class="col-lg-7">
                    <div class="container mt-5">
                        <p class="text-3-5">
                            Nuestro módulo de Tablero de Control te ofrece una visión clara y actualizada del rendimiento de tu organización.
                        </p>
                        <p class="text-3-5">
                            El tablero de control es una herramienta que presenta el estado actual de los indicadores clave, planes y estrategias de la organización, permitiendo:

                        </p>
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Monitorear el rendimiento:</h4>
                                <p class="text-3-5">
                                    Visualizar el progreso hacia los objetivos establecidos.</p>

                                <h4>Diagnosticar situaciones:</h4>
                                <p class="text-3-5">Identificar rápidamente áreas de oportunidad y posibles problemas.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Facilitar la toma de decisiones:</h4>
                                <p class="text-3-5">Contar con información precisa y oportuna para decisiones estratégicas.</p>

                                <h4>Alinear estrategias:</h4>
                                <p class="text-3-5">Asegurar que todas las áreas de la organización estén alineadas con los objetivos generales.</p>
                            </div>
                        </div>

                        <h4>Nuestro módulo de Tablero de Control te permite:</h4>
                        <ul class="text-3-5">
                            <li>Personalizar los indicadores y visualizaciones según tus necesidades.</li>
                            <li>Carga masiva de avance de indicadores.</li>
                            <li>Automatizar la recopilación y actualización de datos.</li>
                            <li>Generar análisis detallados.</li>
                            <li>Tomar decisiones basadas en datos.</li>
                        </ul>

                        <p class="text-3-5">Con nuestro módulo de Tablero de Control, podrás tener una visión integral del rendimiento de tu organización, tomar decisiones informadas y alcanzar tus objetivos estratégicos de manera más eficiente.</p>
                    </div>
                </div>
